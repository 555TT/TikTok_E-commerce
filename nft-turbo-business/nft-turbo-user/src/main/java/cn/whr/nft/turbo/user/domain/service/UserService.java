...
import cn.whr.nft.turbo.api.user.constant.UserOperateTypeEnum;
...
import cn.whr.nft.turbo.api.user.response.data.InviteRankInfo;
...
import cn.whr.nft.turbo.user.infrastructure.exception.UserErrorCode;
import cn.whr.nft.turbo.user.infrastructure.exception.UserException;
import cn.whr.nft.turbo.user.infrastructure.mapper.UserMapper;
